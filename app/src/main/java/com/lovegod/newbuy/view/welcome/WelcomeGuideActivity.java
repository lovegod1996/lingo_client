...
import com.lovegod.newbuy.view.SplashActivity;
import com.lovegod.newbuy.view.utils.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
	...
	protected void onPause() {
		...
		SpUtils.putBoolean(WelcomeGuideActivity.this, Commen.FIRST_OPEN, true);
		finish();
	}
